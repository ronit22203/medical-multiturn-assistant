...
class ToolRegistry:
    def __init__(self):
        ...
        self.recorded_readings: Dict[str, Dict[str, Any]] = {}
    ...
    def execute_tool(self, tool_name: str, raw_args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if (
            tool_name == "start_measurement"
            and isinstance(result, dict)
            and isinstance(result.get("readings"), dict)
            and result["readings"]
        ):
            measurement_type = str(result.get("measurement_type") or "unknown")
            self.recorded_readings[measurement_type] = result["readings"]
        return result
